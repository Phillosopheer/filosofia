    ...
    if (!data.threads || data.threads.length === 0) {
      listEl.innerHTML = `
        <div class="agora-empty">
          ...
          ${!canCreate ? `<div class="agora-login-notice" style="margin-top:22px;">თემის გასახსნელად საჭიროა <span id="agoraEmptyLoginLink" style="color:var(--gold);cursor:pointer;text-decoration:underline;">შესვლა / რეგისტრაცია</span></div>` : ''}
        </div>`;
