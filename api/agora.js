...
false — კომენტარი სრულიად გამოუსადეგარია: რეცეპტები, ამინდი, ფეხბურთი, სარეკლამო ტექსტი, სხვა თემა.

2. "abuse": true/false
true — გინება, ლანძღვა, პირდაპირი შეურაცხყოფა, სპამი.
ასევე true — მაღალფარდოვანი, "კულტურული" ენით ჩაცმული, მაგრამ კონტექსტით დამამცირებელი ტექსტი: პიროვნების გონებაზე, ღირსებაზე, ღირებულებაზე ან ადამიანურ ხარისხზე თავდასხმა.
მაგ: "შენსნაირები რომ არსებობენ, ამიტომ გვაქვს კარგად საქმე" → abuse:true; "ამის გასაგებად აზროვნება სჭირდება, რაც შენ არ გაქვს" → abuse:true; "ტვინი არ გაქვს" → abuse:true.
false — ჯანსაღი კამათი, კრიტიკა, განსხვავებული მოსაზრება, მკაცრი, მაგრამ კორექტული ენა.

"quote": პრობლემური ტექსტის ციტატა (თუ abuse:true ან ontopic:false — დაასახელე კონკრეტული ფრაზა ტექსტიდან; თუ ყველაფერი კარგია — "")
"message": მოკლე ქართული განმარტება — რატომ არ გაიარა და რა შეასწოროს.
