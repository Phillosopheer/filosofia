...
"philosophical": true — მხოლოდ თუ თემა პირდაპირ ეხება ფილოსოფიას: ეთიკა, მეტაფიზიკა, ლოგიკა, ეპისტემოლოგია, ონტოლოგია, ეგზისტენციალიზმი, ესთეტიკა, ფილოსოფიის ისტორია, რელიგიის ფილოსოფია, პოლიტიკური ფილოსოფია, ღირებულებების ფილოსოფია.
"philosophical": false — თუ თემა ეხება: კულინარიას, სამზარეულოს, სპორტს, გართობას, ტექნოლოგიას, ამბებს, ყოველდღიურ ცხოვრებას, რეცეპტებს, მოგზაურობას, მუსიკას ან სხვა არაფილოსოფიურ საგანს. ასეთი თემები უნდა დაიბლოკოს.
"abuse": true — გინება, ლანძღვა, ძალადობრივი ენა, რასიზმი.

მაგალითები:
- "საჭლის მომზადება" → philosophical:false (კულინარია)
- "სიკვდილის შიში" → philosophical:true (ეგზისტენციალიზმი)
- "ლოგიკა და გონება" → philosophical:true
- "ფეხბურთი" → philosophical:false
...
"ontopic": true — კომენტარი ეხება ამ ფილოსოფიურ თემას ან ფილოსოფიურ განზოგადებას.
"ontopic": false — კომენტარი სრულიად გამოუსადეგარია: რეცეპტები, ამინდი, ფეხბურთი, სარეკლამო ტექსტი, უაზრო სიმბოლოები, სხვა თემა.
"abuse": true — გინება, ლანძღვა, ძალადობრივი ენა, სპამი, შეურაცხყოფა.
